...
//  TallyGoKit
//
//  Created by David Deller on 11/20/18.
...
@property (strong, nonatomic) IBOutletCollection(NSObject) NSArray* foursquareResultsIconTargets;
@property (strong, nonatomic) IBOutletCollection(NSObject) NSArray* yelpResultsIconTargets;
@property (strong, nonatomic) IBOutletCollection(NSObject) NSArray* genericResultsIconTargets;
...
+ (UIImage*)imageOfFoursquareResultsIcon;
+ (UIImage*)imageOfYelpResultsIcon;
+ (UIImage*)imageOfGenericResultsIcon;
